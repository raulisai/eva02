...
export const WEAR_COMMANDS: WearCommand[] = [
  ...
  },
  {
    ...
    direction: 'watch_to_core',
    label: 'Add event',
    description: 'Create a schedule event from the watch (one-time or recurring).',
    category: 'agent',
    approval_level: 0,
    example: {
      request_type: 'schedule.add',
      title: 'Gym',
      event_type: 'recurring',
      recurrence: { days: ['tue', 'thu'], time: '07:00' },
      location_type: 'gym',
    },
  },
  {
    ...
    direction: 'watch_to_core',
    label: 'View schedule',
    description: 'Get today\'s and upcoming events as a compact list for the watch face.',
    category: 'agent',
    approval_level: 0,
    example: { request_type: 'schedule.view', days: 3 },
  },
  {
    id: 'location.update',
    direction: 'watch_to_core',
    label: 'Location ping',
    description: 'Send current GPS position to update known_places and detect behavior patterns.',
    category: 'sensors',
    approval_level: 1,
    example: { request_type: 'location.update', lat: 19.4326, lng: -99.1332, accuracy_m: 10 },
  },
  {
    id: 'memory.save',
    direction: 'watch_to_core',

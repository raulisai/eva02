...
const QUICK_SIGNALS = /\b(busca|buscar|b[uú]squeda|clima|tiempo en|precio|cotiza|noticias|tipo de cambio|convierte|cu[aá]nto (cuesta|vale|es)|resume|revisa|traduce|correo|email|notificaciones|agenda|recu[eé]rdame|define|qu[eé] es)\b/i;

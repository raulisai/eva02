...
For PPTX, use a dedicated approved document workflow; this curated runtime skill no longer bundles PowerPoint editing.
...
- For Word docs: `python-docx` is better than OCR, but installing it requires approval.
- For PowerPoint: use an approved document workflow outside this curated runtime skill set.

...
- **WhatsApp Visual Reading**: `whatsapp_read` combines DOM extraction with screenshot vision, including `unanswered_only` requests where the vision prompt looks for unread color, badges, and last-message direction/candidates instead of accepting a generic privacy refusal.
